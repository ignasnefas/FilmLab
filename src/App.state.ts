...
export function useFilmLabState() {
  ...
  const [overlayCategory, setOverlayCategory] = useState<'lightleaks' | 'bokeh' | 'textures'>('lightleaks');
  ...
  const handleSaveCustom = handleSaveCustomPreset;
